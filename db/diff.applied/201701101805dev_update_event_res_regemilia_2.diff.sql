...
UPDATE `meeting_event_reservations`
  SET `suggested_minutes`=5, `suggested_seconds`=45, `suggested_hundreds`=0, `swimmer_id`=64, `meeting_id`=16207, `team_id`=1, `badge_id`=55661, `meeting_event_id`=10006, `user_id`=2, `created_at`='2017-01-10 14:02:33', `updated_at`='2017-01-10 17:05:16', `is_doing_this`=1
  WHERE (`id`=633);

UPDATE `meeting_event_reservations`
  SET `is_doing_this`=1, `swimmer_id`=64, `suggested_minutes`=5, `suggested_seconds`=45, `suggested_hundreds`=0, `meeting_id`=16207, `team_id`=1, `badge_id`=55661, `meeting_event_id`=10006, `user_id`=2, `created_at`='2017-01-10 14:02:33', `updated_at`='2017-01-10 17:05:16'
  WHERE (`id`=633);

UPDATE `meeting_event_reservations`
  SET `suggested_minutes`=0, `suggested_seconds`=36, `suggested_hundreds`=50, `swimmer_id`=64, `meeting_id`=16207, `team_id`=1, `badge_id`=55661, `meeting_event_id`=10007, `user_id`=2, `created_at`='2017-01-10 14:02:33', `updated_at`='2017-01-10 17:05:16', `is_doing_this`=1
  WHERE (`id`=634);

UPDATE `meeting_event_reservations`
  SET `is_doing_this`=1, `swimmer_id`=64, `suggested_minutes`=0, `suggested_seconds`=36, `suggested_hundreds`=50, `meeting_id`=16207, `team_id`=1, `badge_id`=55661, `meeting_event_id`=10007, `user_id`=2, `created_at`='2017-01-10 14:02:33', `updated_at`='2017-01-10 17:05:16'
  WHERE (`id`=634);
