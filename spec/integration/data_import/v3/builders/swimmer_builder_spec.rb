...
require_relative '../../../../../app/data_import/v3/builders/swimmer_builder'


shared_examples_for "SwimmerBuilder with NO matching entity rows" do
...
shared_examples_for "SwimmerBuilder with a matching primary entity row" do
  it "returns a V3::EntityBuilder instance" do
    expect( subject ).to be_an_instance_of( V3::EntityBuilder )
  end
  describe "#data_import_session" do
...
shared_examples_for "SwimmerBuilder with a matching secondary entity row" do
  it "returns a V3::EntityBuilder instance" do
    expect( subject ).to be_an_instance_of( V3::EntityBuilder )
  end
  describe "#data_import_session" do
...
describe V3::SwimmerBuilder, type: :integration do
  ...
  context "after a self.build() with invalid parameters," do
    subject do
      V3::SwimmerBuilder.build_from_parameters(
        data_import_session,
        nil,
        swimmer_year,
        gender_type,
  ...
  context "after a self.build() with NO matching entity rows," do
    ...
    it_behaves_like "SwimmerBuilder with NO matching entity rows"
  end
...
#      puts "- MIR/PRG:      #{mir.meeting_program.inspect}"
  ...
  context "after a self.build() with a matching primary entity row," do
    ...
    it_behaves_like "SwimmerBuilder with a matching primary entity row"
  end
  ...
  context "after a self.build() with a matching secondary entity row," do
    ...
    it_behaves_like "SwimmerBuilder with a matching secondary entity row"
  end
  #-- -------------------------------------------------------------------------
  #++
