--
-- MeetingReservationMatrixUpdater recorded from actions by [User: Cavallo (Luca Valcavi) ID: 22]
-- 10 January 2017 18:49:27
-- Begin script
--
...
UPDATE `meeting_event_reservations`
  SET `suggested_minutes`=0, `suggested_seconds`=35, `suggested_hundreds`=33, `swimmer_id`=1025, `meeting_id`=16207, `team_id`=1, `badge_id`=55668, `meeting_event_id`=9994, `user_id`=2, `created_at`='2017-01-10 14:02:38', `updated_at`='2017-01-10 14:02:38', `is_doing_this`=0
  WHERE (`id`=750);
...
UPDATE `meeting_event_reservations`
  SET `suggested_minutes`=2, `suggested_seconds`=8, `suggested_hundreds`=0, `swimmer_id`=1025, `meeting_id`=16207, `team_id`=1, `badge_id`=55668, `meeting_event_id`=10003, `user_id`=2, `created_at`='2017-01-10 14:02:38', `updated_at`='2017-01-10 17:49:34', `is_doing_this`=1
  WHERE (`id`=756);
