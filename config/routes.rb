...
#  mount DjMon::Engine      => 'goggles_dj_mon'
  ...
  scope "/" do
    scope "(:locale)", locale: /it|en/ do
      ...
      get  "data_import/home/result/:id",   to: "data_import/home#result", as: "di_result"
    end
  end

  # === Local admin API used mainly to populate drop-down list boxes: ===
  get 'json_search/swimmers', format: "json"
  get 'json_search/teams',    format: "json"
  get 'json_search/meetings', format: "json"
  get 'json_search/pools',    format: "json"
end
