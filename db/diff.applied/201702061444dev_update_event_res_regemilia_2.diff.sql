...
UPDATE `meeting_relay_reservations`
  SET `is_doing_this`=1, `swimmer_id`=192, `meeting_id`=16207, `user_id`=38, `team_id`=1, `badge_id`=55644, `meeting_event_id`=9996, `notes`='', `created_at`='2017-01-11 02:12:52', `updated_at`='2017-02-06 13:36:00'
  WHERE (`id`=78);
...
UPDATE `meeting_relay_reservations`
  SET `notes`='', `swimmer_id`=138, `meeting_id`=16207, `user_id`=38, `team_id`=1, `badge_id`=55645, `meeting_event_id`=9997, `is_doing_this`=1, `created_at`='2017-01-11 02:12:52', `updated_at`='2017-02-06 13:36:00'
  WHERE (`id`=83);
