--
-- MeetingReservationMatrixUpdater recorded from actions by [User: Gabry (Gabriele Canovi) ID: 228]
-- 01 February 2017 13:33:46
-- Begin script
--
...
UPDATE `meeting_relay_reservations`
  SET `is_doing_this`=1, `swimmer_id`=1409, `meeting_id`=16207, `user_id`=38, `team_id`=1, `badge_id`=55650, `meeting_event_id`=9998, `notes`=';2', `created_at`='2017-01-11 02:12:52', `updated_at`='2017-02-01 09:17:06'
  WHERE (`id`=105);

UPDATE `meeting_relay_reservations`
  SET `notes`=';2', `swimmer_id`=1409, `meeting_id`=16207, `user_id`=38, `team_id`=1, `badge_id`=55650, `meeting_event_id`=9998, `is_doing_this`=1, `created_at`='2017-01-11 02:12:52', `updated_at`='2017-02-01 09:17:06'
  WHERE (`id`=105);
