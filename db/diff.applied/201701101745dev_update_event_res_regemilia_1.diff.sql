...
UPDATE `meeting_event_reservations`
  SET `suggested_minutes`=0, `suggested_seconds`=30, `suggested_hundreds`=80, `swimmer_id`=142, `meeting_id`=16207, `team_id`=1, `badge_id`=55640, `meeting_event_id`=10007, `user_id`=2, `created_at`='2017-01-10 14:02:12', `updated_at`='2017-01-10 14:02:12', `is_doing_this`=0
  WHERE (`id`=256);
...
UPDATE `meeting_event_reservations`
  SET `suggested_minutes`=1, `suggested_seconds`=18, `suggested_hundreds`=40, `swimmer_id`=142, `meeting_id`=16207, `team_id`=1, `badge_id`=55640, `meeting_event_id`=10008, `user_id`=2, `created_at`='2017-01-10 14:02:12', `updated_at`='2017-01-10 14:02:12', `is_doing_this`=0
  WHERE (`id`=257);
...
UPDATE `meeting_reservations`
  SET `is_not_coming`=0, `swimmer_id`=138, `meeting_id`=16207, `user_id`=2, `team_id`=1, `badge_id`=55645, `notes`='', `has_confirmed`=0, `created_at`='2017-01-10 14:02:17', `updated_at`='2017-01-10 14:17:16'
  WHERE (`id`=67);
