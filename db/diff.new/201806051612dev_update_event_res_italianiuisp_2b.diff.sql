...
--
-- MeetingReservationMatrixUpdater recorded from actions by [User: leega (Marco Ligabue) - leegaweb@gmail.com ID: 2]
-- 05 June 2018 16:12:22
-- Begin script
--

UPDATE `meeting_relay_reservations`
  SET `is_doing_this`=1, `meeting_id`=17501, `user_id`=2, `team_id`=224, `swimmer_id`=142, `badge_id`=110017, `meeting_event_id`=18284, `notes`=NULL, `created_at`='2018-05-04 08:54:44', `updated_at`='2018-06-05 14:12:22'
  WHERE (`id`=2182);

UPDATE `meeting_relay_reservations`
  SET `is_doing_this`=1, `meeting_id`=17501, `user_id`=2, `team_id`=224, `swimmer_id`=142, `badge_id`=110017, `meeting_event_id`=18296, `notes`=NULL, `created_at`='2018-05-04 08:54:44', `updated_at`='2018-06-05 14:12:22'
  WHERE (`id`=2185);
