...
UPDATE meeting_programs SET begin_time = '2000-01-01 15:42' WHERE id = 163795;

-- Event #21, M.Prg: 163761, tot. athletes: 4
-- Tot. progr. duration: 249 (sec), Heat durations: [24930] (hds)
-- Session begin time: 2000-01-01 15:00:00 UTC, Computed begin time: 2000-01-01 15:49:26 UTC
UPDATE meeting_programs SET begin_time = '2000-01-01 15:49' WHERE id = 163761;
...
UPDATE meeting_programs SET begin_time = '2000-01-01 16:19' WHERE id = 163793;
...
UPDATE meeting_programs SET begin_time = '2000-01-01 16:22' WHERE id = 163785;
...
-- Event #5, M.Prg: 163742, tot. athletes: 7
...
UPDATE meeting_programs SET begin_time = '2000-01-01 16:34' WHERE id = 163742;

-- Event #5, M.Prg: 163798, tot. athletes: 1
-- Tot. progr. duration: 124 (sec), Heat durations: [12400] (hds)
-- Session begin time: 2000-01-01 15:00:00 UTC, Computed begin time: 2000-01-01 16:36:11 UTC
UPDATE meeting_programs SET begin_time = '2000-01-01 16:36' WHERE id = 163798;
...
UPDATE meeting_programs SET begin_time = '2000-01-01 16:44' WHERE id = 163780;

-- Event #12, M.Prg: 163749, tot. athletes: 13
-- Tot. progr. duration: 220 (sec), Heat durations: [12350, 9700] (hds)
-- Session begin time: 2000-01-01 15:00:00 UTC, Computed begin time: 2000-01-01 16:47:43 UTC
UPDATE meeting_programs SET begin_time = '2000-01-01 16:47' WHERE id = 163749;
...
UPDATE meeting_programs SET begin_time = '2000-01-01 16:55' WHERE id = 163772;

-- Event #22, M.Prg: 163764, tot. athletes: 11
-- Tot. progr. duration: 166 (sec), Heat durations: [10600, 6000] (hds)
-- Session begin time: 2000-01-01 15:00:00 UTC, Computed begin time: 2000-01-01 16:57:06 UTC
UPDATE meeting_programs SET begin_time = '2000-01-01 16:57' WHERE id = 163764;
...
UPDATE meeting_programs SET begin_time = '2000-01-01 17:17' WHERE id = 163791;

-- Event #10, M.Prg: 163747, tot. athletes: 6
-- Tot. progr. duration: 142 (sec), Heat durations: [14200] (hds)
-- Session begin time: 2000-01-01 15:00:00 UTC, Computed begin time: 2000-01-01 17:20:31 UTC
UPDATE meeting_programs SET begin_time = '2000-01-01 17:20' WHERE id = 163747;
...
UPDATE meeting_programs SET begin_time = '2000-01-01 17:27' WHERE id = 163778;

-- Event #30, M.Prg: 163788, tot. athletes: 4
-- Tot. progr. duration: 190 (sec), Heat durations: [19000] (hds)
-- Session begin time: 2000-01-01 15:00:00 UTC, Computed begin time: 2000-01-01 17:29:43 UTC
UPDATE meeting_programs SET begin_time = '2000-01-01 17:29' WHERE id = 163788;
...
UPDATE meeting_programs SET begin_time = '2000-01-01 17:42' WHERE id = 163738;

-- Event #1, M.Prg: 163763, tot. athletes: 6
-- Tot. progr. duration: 108 (sec), Heat durations: [10800] (hds)
-- Session begin time: 2000-01-01 15:00:00 UTC, Computed begin time: 2000-01-01 17:45:30 UTC
UPDATE meeting_programs SET begin_time = '2000-01-01 17:45' WHERE id = 163763;
...
-- Event #6, M.Prg: 163743, tot. athletes: 8
-- Tot. progr. duration: 100 (sec), Heat durations: [10000] (hds)
...
UPDATE meeting_programs SET begin_time = '2000-01-01 17:54' WHERE id = 163744;

-- Event #7, M.Prg: 163755, tot. athletes: 9
-- Tot. progr. duration: 185 (sec), Heat durations: [9700, 8800] (hds)
-- Session begin time: 2000-01-01 15:00:00 UTC, Computed begin time: 2000-01-01 17:55:56 UTC
UPDATE meeting_programs SET begin_time = '2000-01-01 17:55' WHERE id = 163755;
...
UPDATE meeting_programs SET begin_time = '2000-01-01 18:06' WHERE id = 163758;

-- Event #18, M.Prg: 163770, tot. athletes: 9
-- Tot. progr. duration: 179 (sec), Heat durations: [9100, 8830] (hds)
-- Session begin time: 2000-01-01 15:00:00 UTC, Computed begin time: 2000-01-01 18:08:34 UTC
UPDATE meeting_programs SET begin_time = '2000-01-01 18:08' WHERE id = 163770;
...
UPDATE meeting_programs SET begin_time = '2000-01-01 18:16' WHERE id = 163766;

-- Event #20, M.Prg: 163760, tot. athletes: 7
-- Tot. progr. duration: 102 (sec), Heat durations: [10200] (hds)
-- Session begin time: 2000-01-01 15:00:00 UTC, Computed begin time: 2000-01-01 18:19:34 UTC
UPDATE meeting_programs SET begin_time = '2000-01-01 18:19' WHERE id = 163760;
...
UPDATE meeting_programs SET begin_time = '2000-01-01 18:21' WHERE id = 163784;

-- Event #27, M.Prg: 163775, tot. athletes: 5
-- Tot. progr. duration: 99 (sec), Heat durations: [9980] (hds)
-- Session begin time: 2000-01-01 15:00:00 UTC, Computed begin time: 2000-01-01 18:22:51 UTC
UPDATE meeting_programs SET begin_time = '2000-01-01 18:22' WHERE id = 163775;
