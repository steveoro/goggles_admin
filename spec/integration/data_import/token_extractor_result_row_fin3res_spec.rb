...
#require_relative '../../../data_import/v2/fin3_result_consts'


describe "TokenExtractor for RESULT_ROW-type buffers,", type: :integration do
  class DummyWrapperForFin3ResTokenExtSpecs; include Fin3ResultConsts; end
  let( :dummy_wrapper2 ) { DummyWrapperForFin3ResTokenExtSpecs.new }
