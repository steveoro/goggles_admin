...
=== Example (for entity Season):
    ...
    builder = V3::EntityBuilder.build( data_import_session ) do
...
class V3::EntityBuilder
  ...
  def self.build( data_import_session, &block )
    ...
    V3::EntityBuilder.new( data_import_session, &block )
  end
  #-- -------------------------------------------------------------------------
  #++
