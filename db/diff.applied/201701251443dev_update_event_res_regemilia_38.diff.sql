...
UPDATE `meeting_relay_reservations`
  SET `is_doing_this`=0, `swimmer_id`=1788, `meeting_id`=16207, `user_id`=38, `team_id`=1, `badge_id`=55662, `meeting_event_id`=9998, `notes`='', `created_at`='2017-01-11 02:12:53', `updated_at`='2017-01-24 18:19:30'
  WHERE (`id`=153);
