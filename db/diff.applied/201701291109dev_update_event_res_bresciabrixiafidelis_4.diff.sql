...
UPDATE `meeting_event_reservations`
  SET `suggested_minutes`=1, `suggested_seconds`=27, `suggested_hundreds`=90, `swimmer_id`=98, `meeting_id`=16217, `team_id`=1, `badge_id`=55664, `meeting_event_id`=10133, `user_id`=2, `created_at`='2017-01-26 07:49:22', `updated_at`='2017-01-26 07:49:22', `is_doing_this`=0
  WHERE (`id`=1634);

UPDATE `meeting_event_reservations`
  SET `is_doing_this`=1, `swimmer_id`=98, `suggested_minutes`=1, `suggested_seconds`=27, `suggested_hundreds`=90, `meeting_id`=16217, `team_id`=1, `badge_id`=55664, `meeting_event_id`=10133, `user_id`=2, `created_at`='2017-01-26 07:49:22', `updated_at`='2017-01-29 10:09:21'
  WHERE (`id`=1634);
...
UPDATE `meeting_event_reservations`
  SET `suggested_minutes`=2, `suggested_seconds`=54, `suggested_hundreds`=65, `swimmer_id`=98, `meeting_id`=16217, `team_id`=1, `badge_id`=55664, `meeting_event_id`=10137, `user_id`=2, `created_at`='2017-01-26 07:49:22', `updated_at`='2017-01-26 07:49:22', `is_doing_this`=0
  WHERE (`id`=1638);
