...
require_relative '../../app/data_import/uisp_result_consts'
require_relative '../../app/data_import/context_type_def'
require_relative '../../app/data_import/services/token_extractor'


describe UispResultConsts, type: :model do

  context "as an included module," do
    subject { class UispResultConsts::DummyWrapperForUispResConstsSpecs; include UispResultConsts; end }
