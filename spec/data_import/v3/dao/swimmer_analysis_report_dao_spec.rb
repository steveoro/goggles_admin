...
require_relative '../../../../app/data_import/v3/dao/swimmer_analysis_report_dao'
#require_relative '../../../../app/strategies/fuzzy_string_matcher'


describe V3::SwimmerAnalysisReportDAO, type: :model do

  context "as an empty, valid instance," do
    subject { V3::SwimmerAnalysisReportDAO.new( nil, nil, nil, nil, '' ) }
