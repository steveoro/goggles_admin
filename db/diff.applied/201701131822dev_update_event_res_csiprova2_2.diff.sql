...
UPDATE `meeting_reservations`
  SET `has_confirmed`=0, `swimmer_id`=20995, `meeting_id`=16102, `user_id`=2, `team_id`=1, `badge_id`=60243, `notes`='', `is_not_coming`=0, `created_at`='2017-01-10 11:52:55', `updated_at`='2017-01-13 16:47:32'
  WHERE (`id`=49);
...
UPDATE `meeting_event_reservations`
  SET `suggested_minutes`=0, `suggested_seconds`=40, `suggested_hundreds`=0, `swimmer_id`=20995, `meeting_id`=16102, `team_id`=1, `badge_id`=60243, `meeting_event_id`=6700, `user_id`=2, `created_at`='2017-01-10 11:52:55', `updated_at`='2017-01-13 17:22:16', `is_doing_this`=0
  WHERE (`id`=194);

UPDATE `meeting_event_reservations`
  SET `is_doing_this`=1, `swimmer_id`=20995, `suggested_minutes`=0, `suggested_seconds`=40, `suggested_hundreds`=0, `meeting_id`=16102, `team_id`=1, `badge_id`=60243, `meeting_event_id`=6700, `user_id`=2, `created_at`='2017-01-10 11:52:55', `updated_at`='2017-01-13 17:22:16'
  WHERE (`id`=194);
...
UPDATE `meeting_event_reservations`
  SET `suggested_minutes`=1, `suggested_seconds`=15, `suggested_hundreds`=0, `swimmer_id`=20995, `meeting_id`=16102, `team_id`=1, `badge_id`=60243, `meeting_event_id`=6702, `user_id`=2, `created_at`='2017-01-10 11:52:55', `updated_at`='2017-01-13 17:22:16', `is_doing_this`=0
  WHERE (`id`=196);

UPDATE `meeting_event_reservations`
  SET `is_doing_this`=1, `swimmer_id`=20995, `suggested_minutes`=1, `suggested_seconds`=15, `suggested_hundreds`=0, `meeting_id`=16102, `team_id`=1, `badge_id`=60243, `meeting_event_id`=6702, `user_id`=2, `created_at`='2017-01-10 11:52:55', `updated_at`='2017-01-13 17:22:16'
  WHERE (`id`=196);
