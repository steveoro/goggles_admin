...
UPDATE `meeting_event_reservations`
  SET `suggested_minutes`=5, `suggested_seconds`=40, `suggested_hundreds`=40, `swimmer_id`=64, `meeting_id`=16207, `team_id`=1, `badge_id`=55661, `meeting_event_id`=10006, `user_id`=2, `created_at`='2017-01-10 14:02:33', `updated_at`='2017-01-10 14:02:33', `is_doing_this`=0
  WHERE (`id`=633);

UPDATE `meeting_event_reservations`
  SET `is_doing_this`=1, `swimmer_id`=64, `suggested_minutes`=5, `suggested_seconds`=40, `suggested_hundreds`=40, `meeting_id`=16207, `team_id`=1, `badge_id`=55661, `meeting_event_id`=10006, `user_id`=2, `created_at`='2017-01-10 14:02:33', `updated_at`='2017-01-10 17:02:15'
  WHERE (`id`=633);

UPDATE `meeting_event_reservations`
  SET `suggested_minutes`=0, `suggested_seconds`=34, `suggested_hundreds`=20, `swimmer_id`=64, `meeting_id`=16207, `team_id`=1, `badge_id`=55661, `meeting_event_id`=10007, `user_id`=2, `created_at`='2017-01-10 14:02:33', `updated_at`='2017-01-10 14:02:33', `is_doing_this`=0
  WHERE (`id`=634);

UPDATE `meeting_event_reservations`
  SET `is_doing_this`=1, `swimmer_id`=64, `suggested_minutes`=0, `suggested_seconds`=34, `suggested_hundreds`=20, `meeting_id`=16207, `team_id`=1, `badge_id`=55661, `meeting_event_id`=10007, `user_id`=2, `created_at`='2017-01-10 14:02:33', `updated_at`='2017-01-10 17:02:15'
  WHERE (`id`=634);
...
UPDATE `meeting_event_reservations`
  SET `suggested_minutes`=2, `suggested_seconds`=52, `suggested_hundreds`=17, `swimmer_id`=98, `meeting_id`=16207, `team_id`=1, `badge_id`=55664, `meeting_event_id`=10003, `user_id`=2, `created_at`='2017-01-10 14:02:35', `updated_at`='2017-01-10 16:47:12', `is_doing_this`=1
  WHERE (`id`=684);
