...
UPDATE `meeting_event_reservations`
  SET `suggested_minutes`=0, `suggested_seconds`=35, `suggested_hundreds`=33, `swimmer_id`=1025, `meeting_id`=16207, `team_id`=1, `badge_id`=55668, `meeting_event_id`=9994, `user_id`=2, `created_at`='2017-01-10 14:02:38', `updated_at`='2017-01-10 17:49:34', `is_doing_this`=1
  WHERE (`id`=750);
