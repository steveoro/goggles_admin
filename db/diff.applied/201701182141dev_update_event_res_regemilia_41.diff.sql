--
-- MeetingReservationMatrixUpdater recorded from actions by [User: Ido (Ido Pieraldo Orlandini) ID: 41]
-- 18 January 2017 21:41:28
-- Begin script
--
...
UPDATE `meeting_event_reservations`
  SET `suggested_minutes`=1, `suggested_seconds`=17, `suggested_hundreds`=40, `swimmer_id`=64, `meeting_id`=16207, `team_id`=1, `badge_id`=55661, `meeting_event_id`=10000, `user_id`=2, `created_at`='2017-01-10 14:02:33', `updated_at`='2017-01-10 14:02:33', `is_doing_this`=0
  WHERE (`id`=628);

UPDATE `meeting_event_reservations`
  SET `is_doing_this`=1, `swimmer_id`=64, `suggested_minutes`=1, `suggested_seconds`=17, `suggested_hundreds`=40, `meeting_id`=16207, `team_id`=1, `badge_id`=55661, `meeting_event_id`=10000, `user_id`=2, `created_at`='2017-01-10 14:02:33', `updated_at`='2017-01-18 20:41:37'
  WHERE (`id`=628);

UPDATE `meeting_event_reservations`
  SET `suggested_minutes`=2, `suggested_seconds`=31, `suggested_hundreds`=70, `swimmer_id`=64, `meeting_id`=16207, `team_id`=1, `badge_id`=55661, `meeting_event_id`=10003, `user_id`=2, `created_at`='2017-01-10 14:02:33', `updated_at`='2017-01-10 14:02:33', `is_doing_this`=0
  WHERE (`id`=630);

UPDATE `meeting_event_reservations`
  SET `is_doing_this`=1, `swimmer_id`=64, `suggested_minutes`=2, `suggested_seconds`=31, `suggested_hundreds`=70, `meeting_id`=16207, `team_id`=1, `badge_id`=55661, `meeting_event_id`=10003, `user_id`=2, `created_at`='2017-01-10 14:02:33', `updated_at`='2017-01-18 20:41:38'
  WHERE (`id`=630);

UPDATE `meeting_event_reservations`
  SET `is_doing_this`=0, `suggested_minutes`=0, `suggested_seconds`=0, `suggested_hundreds`=0, `swimmer_id`=64, `meeting_id`=16207, `team_id`=1, `badge_id`=55661, `meeting_event_id`=10006, `user_id`=2, `created_at`='2017-01-10 14:02:33', `updated_at`='2017-01-18 20:41:38'
  WHERE (`id`=633);

UPDATE `meeting_event_reservations`
  SET `is_doing_this`=0, `suggested_minutes`=0, `suggested_seconds`=0, `suggested_hundreds`=0, `swimmer_id`=64, `meeting_id`=16207, `team_id`=1, `badge_id`=55661, `meeting_event_id`=10007, `user_id`=2, `created_at`='2017-01-10 14:02:33', `updated_at`='2017-01-18 20:41:38'
  WHERE (`id`=634);
