...
#    puts "- season.id.......................: #{ season ? season.id : 'nil' } - #{ season.class.name }"
...
#          puts "Searching a missing Season..."
      ...
      search do
# DEBUG
#        puts "- header_fields_dao.header_date...: #{ header_fields_dao.header_date }"
#        puts "- header_fields_dao.code_name.....: #{ header_fields_dao.code_name }"
#        puts "- @season.id (after search).......: #{ @season.id } - #{ @season.class.name }"
        primary    [
...
#       entry_deadline:         header_fields_dao.header_date - 14, # (This is just a guess)
        ...
        configuration_file:     File.basename( header_fields_dao.full_pathname ),
