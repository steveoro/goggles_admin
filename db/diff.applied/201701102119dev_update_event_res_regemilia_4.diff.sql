...
UPDATE `meeting_event_reservations`
  SET `suggested_minutes`=0, `suggested_seconds`=35, `suggested_hundreds`=0, `swimmer_id`=98, `meeting_id`=16207, `team_id`=1, `badge_id`=55664, `meeting_event_id`=10001, `user_id`=2, `created_at`='2017-01-10 14:02:35', `updated_at`='2017-01-10 14:02:35', `is_doing_this`=0
  WHERE (`id`=683);
