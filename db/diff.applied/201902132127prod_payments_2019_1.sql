...
update meetings m set m.relay_fee = 5.00 where m.season_id = 151;
update meetings m set m.event_fee = 3.00 where m.season_id = 161;
update meetings m set m.relay_fee = 5.00 where m.season_id = 161;
update meetings m set m.event_fee = 3.30 where m.season_id = 171;
update meetings m set m.relay_fee = 5.00 where m.season_id = 171;
update meetings m set m.event_fee = 3.30 where m.season_id = 181;
update meetings m set m.relay_fee = 5.00 where m.season_id = 181;
