...
UPDATE `meeting_reservations`
  SET `is_not_coming`=0, `swimmer_id`=20995, `meeting_id`=16102, `user_id`=2, `team_id`=1, `badge_id`=60243, `notes`=NULL, `has_confirmed`=0, `created_at`='2017-01-10 11:52:55', `updated_at`='2017-01-13 16:47:32'
  WHERE (`id`=49);

UPDATE `meeting_reservations`
  SET `has_confirmed`=0, `swimmer_id`=20995, `meeting_id`=16102, `user_id`=2, `team_id`=1, `badge_id`=60243, `notes`=NULL, `is_not_coming`=0, `created_at`='2017-01-10 11:52:55', `updated_at`='2017-01-13 16:47:32'
  WHERE (`id`=49);
