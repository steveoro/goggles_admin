...
UPDATE `meeting_reservations`
  SET `has_confirmed`=1, `swimmer_id`=98, `meeting_id`=16207, `user_id`=2, `team_id`=1, `badge_id`=55664, `notes`='', `is_not_coming`=0, `created_at`='2017-01-10 14:02:35', `updated_at`='2017-01-11 09:29:44'
  WHERE (`id`=86);
...
UPDATE `meeting_event_reservations`
  SET `is_doing_this`=1, `swimmer_id`=98, `suggested_minutes`=0, `suggested_seconds`=35, `suggested_hundreds`=0, `meeting_id`=16207, `team_id`=1, `badge_id`=55664, `meeting_event_id`=10001, `user_id`=2, `created_at`='2017-01-10 14:02:35', `updated_at`='2017-01-10 20:19:32'
  WHERE (`id`=683);
