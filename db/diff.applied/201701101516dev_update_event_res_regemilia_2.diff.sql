...
UPDATE `meeting_reservations`
  SET `is_not_coming`=0, `swimmer_id`=1025, `meeting_id`=16207, `user_id`=2, `team_id`=1, `badge_id`=55668, `notes`='', `has_confirmed`=1, `created_at`='2017-01-10 14:02:37', `updated_at`='2017-01-10 14:15:22'
  WHERE (`id`=90);
