--
-- MeetingReservationMatrixUpdater recorded from actions by [User: monika (Monica Bonacini) ID: 5]
-- 10 January 2017 21:11:08
-- Begin script
--
...
UPDATE `meeting_event_reservations`
  SET `suggested_minutes`=2, `suggested_seconds`=51, `suggested_hundreds`=52, `swimmer_id`=138, `meeting_id`=16207, `team_id`=1, `badge_id`=55645, `meeting_event_id`=10003, `user_id`=2, `created_at`='2017-01-10 14:02:18', `updated_at`='2017-01-10 14:02:18', `is_doing_this`=0
  WHERE (`id`=342);
