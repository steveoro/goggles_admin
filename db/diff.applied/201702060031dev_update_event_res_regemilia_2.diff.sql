...
UPDATE `meeting_relay_reservations`
  SET `is_doing_this`=1, `swimmer_id`=1025, `meeting_id`=16207, `user_id`=38, `team_id`=1, `badge_id`=55668, `meeting_event_id`=9997, `notes`='', `created_at`='2017-01-11 02:12:54', `updated_at`='2017-02-05 23:31:19'
  WHERE (`id`=175);

UPDATE `meeting_relay_reservations`
  SET `notes`='', `swimmer_id`=1025, `meeting_id`=16207, `user_id`=38, `team_id`=1, `badge_id`=55668, `meeting_event_id`=9997, `is_doing_this`=1, `created_at`='2017-01-11 02:12:54', `updated_at`='2017-02-05 23:31:19'
  WHERE (`id`=175);
